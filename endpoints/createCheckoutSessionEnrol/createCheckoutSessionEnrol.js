  ...
  try {
    ...
    try {
      ...
      const leadData = {
        ...
        Date_of_birth__c: data.student.dob,
        Student_Mobile_No__c: data.student.phone,
        ...
        Year_Group__c: data.study.ageGroup,
        Subjects__c: data.study.programmes.map((programme) => programme.name).join(", "),
        Desired_Date__c: data.study.desiredStartDate,
        Parent_Guardian__c: data.parent.guardian,
        Total_Price__c: data.totalPrice,
